...
\section{Проекты}
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          {\textbf{Архиватор файлов} $|$ \emph{C++, Алгоритм Хаффмана} | \href{https://github.com/skewbekkebweks/archiver/tree/main/tasks/archiver}{\underline{github}}}{2023}
          \resumeItemListStart
            \resumeItem{Реализовано сжатие файлов с использованием алгоритма Хаффмана}
          \resumeItemListEnd
          
      \resumeProjectHeading
          {\textbf{Приложение для занятий спортом} $|$ \emph{Java, Android} | \href{https://github.com/skewbekkebweks/chick}{\underline{Android}} | \href{https://github.com/skewbekkebweks/chick_server}{\underline{backend}}}{2022}
          \resumeItemListStart
